...
import { InteractiveNewspaperLoader } from '@/components/loader/NewspaperLoader'; // Assuming this is the correct path
...
export function ReportView({ reportId }: ReportViewProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setIsLoading(false);
    }, 5*60*1000); // Let the loader show for 5 minutes
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <InteractiveNewspaperLoader isLoading={isLoading} loadingText="Compiling Your Report..." />
